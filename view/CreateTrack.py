...
class TrackCreator(tk.Frame):
    ...
    def create_ui(self):
        ...
        self.input_name_bar = tk.Entry(self,font=("Arial", 28), width=48)
        ...
        self.input_artist_bar = tk.Entry(self,font=("Arial", 28), width=48)
        ...
        self.input_rating_bar = tk.Entry(self,font=("Arial", 28), width=48)
        ...
        self.input_youtube_bar = tk.Entry(self,font=("Arial", 28), width=48)
        ...
        self.create_btn.place(x=200, y = 600, height= 50, width= 400)
